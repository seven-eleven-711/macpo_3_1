...
def get_config():
    ...
    Network parameters:
        ...
        --use_centralized_V
            by default True, use centralized training mode; or else will be decentralized training mode.
        --stacked_frames <int>
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo_lagr', choices=["mappo_lagr", "mappo", "IPPO_L"])

    parser.add_argument("--experiment_name", type=str, default="check", help="an identifier to distinguish different experiment.")
    parser.add_argument("--seed", type=int, default=1, help="Random seed for numpy/torch")  # 1
    ...
    parser.add_argument("--n_rollout_threads", type=int, default=40,
                        help="Number of parallel envs for training rollouts")
    parser.add_argument("--n_eval_rollout_threads", type=int, default=1,
                        help="Number of parallel envs for evaluating rollouts")
    parser.add_argument("--n_render_rollout_threads", type=int, default=1,
                        help="Number of parallel envs for rendering rollouts")
    parser.add_argument("--num_env_steps", type=int, default=10e3,      #4*10e5
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='Cold_Rolling', help="specify the name of environment")
    ...
    # todo
    parser.add_argument("--stacked_frames", type=int, default=3,
    ...
    parser.add_argument("--layer_N", type=int, default=3,
                        help="Number of layers for actor/critic networks")      # 2
    ...
    parser.add_argument("--data_chunk_length", type=int, default=10,
                        help="Time length of chunks used to train a recurrent_policy")      #10
    ...
    parser.add_argument("--opti_eps", type=float, default=1e-4,
    ...
    parser.add_argument("--entropy_coef", type=float, default=0.01,     # 策略熵可以改为0.02试试,dist_entropy递增；0.01递减
                        help='entropy term coefficient (default: 0.01)')
    # todo: lagrangian_coef is the lagrangian coefficient for mappo_lagrangian
    parser.add_argument("--lamda_lagr", type=float, default=0.7,
                        help='lagrangrian coef coefficient (default: 0.78)')
    parser.add_argument("--lagrangian_coef_rate", type=float, default=1e-3,
                        help='lagrangrian coef learning rate (default: 5e-4)')

    parser.add_argument("--lagrangian_coef", type=float, default=0.01,       # 0.1
                        help='entropy term coefficient (default: 0.01)')
    ...
    # safe parameters
    parser.add_argument("--safety_bound", type=float, default=0.001, help="constraint upper bound")
