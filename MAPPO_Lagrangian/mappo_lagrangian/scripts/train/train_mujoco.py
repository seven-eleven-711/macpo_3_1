...
from MAPPO_Lagrangian.mappo_lagrangian.envs.env_continuous import ColdRolling
from MAPPO_Lagrangian.mappo_lagrangian.envs.env_wrappers import DummyVecEnv
...
def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            if all_args.env_name == "Cold_Rolling":
...
def parse_args(args, parser):
    ...
    parser.add_argument('--num_agents', type=int, default=5, help="number of players")  # 智能体数量
...
def main(args):
    ...
    # if all_args.algorithm_name == "mappo_lagr" or all_args.algorithm_name == "mappo":
    ...
    #     from MAPPO_Lagrangian.mappo_lagrangian.runner.shared.mujoco_runner import MujocoRunner as Runner
    # else:
    # in origin code not implement this method
    if all_args.algorithm_name == "mappo_lagr" or all_args.algorithm_name == "IPPO_L":
        from MAPPO_Lagrangian.mappo_lagrangian.runner.separated.mujoco_runner_mappo_lagr import MujocoRunner as Runner
    else:
        from MAPPO_Lagrangian.mappo_lagrangian.runner.separated.mujoco_runner import MujocoRunner as Runner  # mappo
