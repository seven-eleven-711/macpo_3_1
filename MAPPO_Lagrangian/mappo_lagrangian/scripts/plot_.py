...
for i in ['h1', 'h2', 'h3', 'h4', 'h5']:
    ...
    plt.grid()
plt.savefig(
            "C:\\Users\\admin\\Desktop\\macpo_3_1\\MAPPO_Lagrangian\\mappo_lagrangian\\scripts\\results\\Deceleration\\" + 'H' + ".svg",
            bbox_inches="tight")
...
for i in ['t12', 't23', 't34', 't45']:
    ...
    plt.grid()
plt.savefig(
            "C:\\Users\\admin\\Desktop\\macpo_3_1\\MAPPO_Lagrangian\\mappo_lagrangian\\scripts\\results\\Deceleration\\" + 'T' + ".svg",
            bbox_inches="tight")
...
#     plt.plot(x, df1, label="MAPPO_L", color='k', linewidth=3)
#     plt.plot(x, df3, label="IPPO_L", color='g', linewidth=3, alpha=0.8)
#     plt.plot(x, df2, label="PI", color='b', linewidth=3, linestyle='--', alpha=0.8)
#     plt.plot(x, ref_, label="ref", color='r', linewidth=3)
#
#     plt.tick_params(labelsize=30)
#     plt.xticks(np.arange(0, 5.1, step=1))
#     plt.title("减速", fontdict={"family": "SimSun", "size": 30, "color": "k"})
#     plt.xlabel("时间/s", fontdict={"family": "SimSun", "size": 30, "color": "k"})
#     if i in ['h1', 'h2', 'h3', 'h4', 'h5']:
#         plt.ylabel(i + "/mm", fontsize=30)
#     else:
#         plt.ylabel(i + "/T", fontsize=30)
#     if i == 'h5':
#         plt.gca().yaxis.set_major_formatter('{:.4f}'.format)
#     else:
#         plt.gca().yaxis.set_major_formatter('{:.3f}'.format)
#     # plt.fill_between(x, df1, ref_, facecolor='#D3D3D3', alpha=0.5)
#     # plt.fill_between(x, df2, ref_, facecolor='#87CEFA', alpha=0.5)
#
#     legend = plt.legend(loc="upper left", prop={'size': 20})
#     for handle in legend.legendHandles:
#         handle.set_alpha(0.8)
#     plt.grid()
#     plt.savefig("C:\\Users\\admin\\Desktop\\macpo_3_1\\MAPPO_Lagrangian\\mappo_lagrangian\\scripts\\results\\Deceleration\\" + i + ".png", dpi=1200, bbox_inches="tight")
