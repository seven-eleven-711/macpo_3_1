...
from MAPPO_Lagrangian.mappo_lagrangian.utils.util import get_gard_norm, huber_loss, mse_loss
from MAPPO_Lagrangian.mappo_lagrangian.utils.popart import PopArt
from MAPPO_Lagrangian.mappo_lagrangian.algorithms.utils.util import check
...
class R_MAPPO_Lagr:
    ...
    def ppo_update(self, sample, update_actor=True, precomputed_eval=None,
        ...
        share_obs_ht_batch, share_obs_vt_batch, obs_batch, rnn_states_batch, rnn_states_critic_batch, actions_batch, \
        ...
        values, action_log_probs, dist_entropy, cost_values = self.policy.evaluate_actions(share_obs_ht_batch,
                                                                                           share_obs_vt_batch,
                                                                                           obs_batch,
                                                                                           rnn_states_batch,
        ...
        return value_loss, critic_grad_norm, policy_loss, dist_entropy, actor_grad_norm, imp_weights, cost_loss, cost_grad_norm, new_lamda_lagr
    ...
    def train(self, buffer, update_actor=True):
        ...
        for _ in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                value_loss, critic_grad_norm, policy_loss, dist_entropy, actor_grad_norm, imp_weights, cost_loss, cost_grad_norm, new_lamda_lagr \
                ...
                train_info['new_lamda_lagr'] += new_lamda_lagr
